...
#ifndef TWOPHOTONTHREAD_H
#define TWOPHOTONTHREAD_H

class TwoPhotonThread : public QThread
{

public:
	//constructors
	TwoPhotonThread(ScanEngine *scanEngi, AcqEngine *acqEngi, DataFile2P *data2Pi, zStepperDriver *zStepper, AomControl *aCtrl);
